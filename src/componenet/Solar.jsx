...
const Solar = () => {
  return (
    ...
    <Grid container spacing={2} justifyContent="center" className="animate__animated animate__slideInLeft">
      <Card sx={{p:2}}>
    ...
    <Grid container spacing={2} sx={{mt:3}} justifyContent="center"className="animate__animated animate__slideInLeft">
      <Card sx={{p:2}}>
